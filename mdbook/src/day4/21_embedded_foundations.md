...
In Chapter 20, we successfully read temperature values from the ESP32-C3's built-in sensor. Now we need to build a system that can:
...
#[entry]
fn main() -> ! {
    // TODO: Initialize hardware (from Chapter 20)
...
**Next**: In Chapter 22, we'll add proper testing strategies for embedded code, including how to test no_std code on desktop and validate hardware behavior.